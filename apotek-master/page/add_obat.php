...
{
	$sql="insert into obat (kode,no_batch,nama_obat,golongan,jenis,bentuk,kemasan,harga_kemasan,harga_resep,harga_nonresep,jumlah,expired) values ('".$_POST['kode']."','".$_POST['no_batch']."','".$_POST['nama_obat']."','".$_POST['golongan']."','".$_POST['jenis']."','".$_POST['bentuk']."','".$_POST['kemasan']."','".$_POST['harga_kemasan']."','".$_POST['harga_resep']."','".$_POST['harga_nonresep']."','".$_POST['jumlah']."','".$_POST['expired']."',)";
